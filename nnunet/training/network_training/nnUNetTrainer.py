...
from nnunet.training.dataloading.dataset_loading import load_dataset, DataLoader3D, DataLoader2D, unpack_dataset, load_dataset_each
...
class nnUNetTrainer(NetworkTrainer):
    ...
    def initialize(self, training=True, force_load_plans=False):
        ...
        if training:
            ...
            self.tr_gen, self.val_gen, self.ts_gen = get_default_augmentation(self.dl_tr, self.dl_val, self.dl_ts,
    ...
    def load_dataset(self):
        ...
        #####################################################################################
        tr_folder = "/data/zirui/lab2/nnUNet/data/nnUNet_raw_data/Task082_BraTS2020/labelsTr"
        val_folder = "/data/zirui/lab2/nnUNet/data/nnUNet_raw_data/Task082_BraTS2020/labelsVal"
        ts_folder = "/data/zirui/lab2/nnUNet/data/nnUNet_raw_data/Task082_BraTS2020/labelsTs"
        self.dataset_tr, self.dataset_val, self.dataset_ts = load_dataset_each(tr_folder, val_folder, ts_folder, self.folder_with_preprocessed_data)
        #####################################################################################
    ...
    def get_basic_generators(self):
        ...
        dl_val = DataLoader3D(self.dataset_val, self.patch_size, self.patch_size, self.batch_size, False,
                                ...
                                pad_mode="constant", pad_sides=self.pad_all_sides, memmap_mode='r')
        dl_ts = DataLoader3D(self.dataset_ts, self.patch_size, self.patch_size, self.batch_size, False,
                                oversample_foreground_percent=self.oversample_foreground_percent,
                                pad_mode="constant", pad_sides=self.pad_all_sides, memmap_mode='r')
        # else:
    ...
    def validate(self, do_mirroring: bool = True, use_sliding_window: bool = True, step_size: float = 0.5,
        ...
        for k in self.dataset_ts.keys():
            ...
            if overwrite or (not isfile(join(output_folder, fname + ".nii"))) or \
                ...
                results.append(export_pool.starmap_async(save_segmentation_nifti_from_softmax,
                                                         ((softmax_pred, join(output_folder, fname + ".nii"),
            ...
            pred_gt_tuples.append([join(output_folder, fname + ".nii"),
