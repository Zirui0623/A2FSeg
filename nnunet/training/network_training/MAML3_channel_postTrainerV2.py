...
class MAML3_channel_postTrainerV2(nnUNetTrainer):
    """
    ...
    def initialize_network(self):
        ...
        self.network = Generic_MAML_multi3_channel_post(self.num_input_channels, self.base_num_features, self.num_classes,
