...
from nnunet.training.network_training.MAML3_channel_decoderTrainerV2 import MAML3_channel_decoderTrainerV2
...
class MAML3_channel_decoderTrainerV2BraTSRegions_BN(MAML3_channel_decoderTrainerV2):
...
class MAML3_channel_decoderTrainerV2BraTSRegions(MAML3_channel_decoderTrainerV2):
...
class MAML3_channel_decoderTrainerV2BraTSRegions_Dice(MAML3_channel_decoderTrainerV2BraTSRegions):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, fp16=False):
        super().__init__(plans_file, fold, output_folder, dataset_directory, batch_dice, stage, unpack_data,
                         deterministic, fp16)
