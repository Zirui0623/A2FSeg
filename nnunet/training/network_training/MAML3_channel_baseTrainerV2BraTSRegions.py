...
from nnunet.network_architecture.my.generic_MAML3_channel_base import Generic_MAML_multi3_channel_base
...
from nnunet.training.network_training.MAML3_channel_baseTrainerV2 import MAML3_channel_baseTrainerV2
...
class MAML3_channel_baseTrainerV2BraTSRegions_BN(MAML3_channel_baseTrainerV2):
...
class MAML3_channel_baseTrainerV2BraTSRegions(MAML3_channel_baseTrainerV2):
...
#################################################################################################
                if self.epoch % 2:
                    ...
                    m_output = self.network(data, subset_index_list, subset_size[0])
...
class MAML3_channel_baseTrainerV2BraTSRegions_Dice(MAML3_channel_baseTrainerV2BraTSRegions):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, fp16=False):
        super().__init__(plans_file, fold, output_folder, dataset_directory, batch_dice, stage, unpack_data,
                         deterministic, fp16)
