...
from nnunet.network_architecture.my.generic_MAML3_channel_post import Generic_MAML_multi3_channel_post
...
from nnunet.training.network_training.MAML3_channel_postTrainerV2 import MAML3_channel_postTrainerV2
...
class MAML3_channel_postTrainerV2BraTSRegions_BN(MAML3_channel_postTrainerV2):
...
class MAML3_channel_postTrainerV2BraTSRegions(MAML3_channel_postTrainerV2):
...
class MAML3_channel_postTrainerV2BraTSRegions_Dice(MAML3_channel_postTrainerV2BraTSRegions):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, fp16=False):
        super().__init__(plans_file, fold, output_folder, dataset_directory, batch_dice, stage, unpack_data,
                         deterministic, fp16)
