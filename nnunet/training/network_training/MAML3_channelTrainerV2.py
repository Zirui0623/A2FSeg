...
class MAML3_channelTrainerV2(nnUNetTrainer):
    """
    ...
    def initialize_network(self):
        ...
        self.network = Generic_MAML_multi3_channel(self.num_input_channels, self.base_num_features, self.num_classes,
...
#############################################################################################
        ...
        # recon_folder_name = 'validation_recon'
        # recon_folder = join(self.output_folder, recon_folder_name)
        # recon_folders = []
        # # string_list = ["1000", "1100", "1110", "1111"]
        # # subset_index_list = [[0], [4], [10], [14]]

        # string_list = ["1111_t1", "1111_t1ce", "1111_t2", "1111_flair"]
        # subset_index_list = [[14]]
        # subset_size = [4]
        
        # # string_list = ["0101_t1ce", "0101_flair"]
        # # subset_index_list = [[8]]
        # # subset_size = [2]

        # for i in range(0, 4):
        #     recon_folders.append(join(recon_folder, string_list[i]))
        #     maybe_mkdir_p(recon_folders[i])
        ...
        #             print("att_map", k, data.shape)
        #             data[-1][data[-1] == -1] = 0
        #             print("gg")
        #             recon_att_t1 = self.predict_preprocessed_data_return_flair(0, data[:-1], subset_index_list[i], subset_size[i],
        ...
        #             recon_att_t1ce = self.predict_preprocessed_data_return_flair(1, data[:-1], subset_index_list[i], subset_size[i],
        #                                                                                 do_mirroring=do_mirroring,
        #                                                                                 mirror_axes=mirror_axes,
        #                                                                                 use_sliding_window=use_sliding_window,
        #                                                                                 step_size=step_size,
        ...
        #             recon_att_t2 = self.predict_preprocessed_data_return_flair(2, data[:-1], subset_index_list[i], subset_size[i],
        #                                                                                 do_mirroring=do_mirroring,
        #                                                                                 mirror_axes=mirror_axes,
        #                                                                                 use_sliding_window=use_sliding_window,
        #                                                                                 step_size=step_size,
        ...
        #             recon_att_flair = self.predict_preprocessed_data_return_flair(3, data[:-1], subset_index_list[i], subset_size[i],
        #                                                                                 do_mirroring=do_mirroring,
        #                                                                                 mirror_axes=mirror_axes,
        #                                                                                 use_sliding_window=use_sliding_window,
        #                                                                                 step_size=step_size,
        ...
        #             # print(recon_att_t1.shape, recon_att_t1ce.shape, recon_att_t2.shape, recon_att_flair.shape)
        #             print(recon_att_t1ce.shape, recon_att_flair.shape)

        #             save_segmentation_nifti(recon_att_t1[0], join(recon_folders[0], fname + ".nii"),
        #                                      properties, interpolation_order, force_separate_z,
        #                                      interpolation_order_z)                    
                    
        #             save_segmentation_nifti(recon_att_t1ce[0], join(recon_folders[1], fname + ".nii"),
        #                                      properties, interpolation_order, force_separate_z,
        #                                      interpolation_order_z)    
                    
        #             save_segmentation_nifti(recon_att_t2[0], join(recon_folders[2], fname + ".nii"),
        #                                      properties, interpolation_order, force_separate_z,
        #                                      interpolation_order_z)    
                    
        #             save_segmentation_nifti(recon_att_flair[0], join(recon_folders[3], fname + ".nii"),
        #                                      properties, interpolation_order, force_separate_z,
        #                                      interpolation_order_z)    
                    
        #             # export_pool.starmap_async(save_segmentation_nifti,((recon_att_t1[0], join("1111_t1", fname + ".nii"),
        #             #                          properties, interpolation_order, force_separate_z,
        #             #                          interpolation_order_z),
        #             # )
        #             # )
        #             # export_pool.starmap_async(save_segmentation_nifti,((recon_att_t1ce[0], join("1111_t1ce", fname + ".nii"),
        #             #                          properties, interpolation_order, force_separate_z,
        #             #                          interpolation_order_z),
        #             # )
        #             # )
        #             # export_pool.starmap_async(save_segmentation_nifti,((recon_att_t2[0], join("1111_t2", fname + ".nii"),
        #             #                          properties, interpolation_order, force_separate_z,
        #             #                          interpolation_order_z),
        #             # )
        #             # )
        #             # export_pool.starmap_async(save_segmentation_nifti,((recon_att_flair[0], join("1111_flair", fname + ".nii"),
        #             #                          properties, interpolation_order, force_separate_z,
        #             #                          interpolation_order_z),
        #             # )
        #             # )
...
#############################################################################################
    def predict_preprocessed_data_return_flair(self, num: int, data: np.ndarray, subset_index_list: list,  subset_size: int, do_mirroring: bool = True,
        ...
        ret = self.network.predict_3D_recon(num, data, subset_index_list,  subset_size, do_mirroring=do_mirroring, mirror_axes=mirror_axes,
