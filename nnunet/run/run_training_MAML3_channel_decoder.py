...
from nnunet.paths import default_plans_identifier, default_batch_01_plans_identifier
...
def main():
    ...
    parser.add_argument("--network_trainer", default='MAML3_channel_decoderTrainerV2BraTSRegions')
    parser.add_argument("--task", default='82', help="can be task name or task id")
    parser.add_argument("--fold", default='each', help='0, 1, ..., 5 or \'all\'')
