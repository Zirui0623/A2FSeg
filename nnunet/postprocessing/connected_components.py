...
def determine_postprocessing(base, gt_labels_folder, raw_subfolder_name="validation_raw",
    ...
    fnames = subfiles(join(base, raw_subfolder_name), suffix=".nii", join=False)
    ...
    pp_results['dc_per_class_pp_per_class'] = {}  # dice scores after removing everything except larges connected component
...
##-------------------------------------folder_all_classes_as_fg----------------------------------------##
    ...
    _ = aggregate_scores(pred_gt_tuples, labels=classes,
                         ...
                         json_author="Zirui", num_threads=processes)
...
#####################################################################################################
##------------------------folder_per_class VS raw_subfolder----------------------------------------##
